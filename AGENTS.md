...
- **`main` is protected** (D-014). Every change is a pull request with 1 approval and squash merge, and only Adrian lands it.
  - Adrian approves teammates' PRs; a teammate approves Adrian's.
