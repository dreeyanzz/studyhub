...
Every pull request needs one approval before it can merge, and only Adrian can merge
(D-014). Adrian approves teammates' PRs, and a teammate approves Adrian's. Nobody can
